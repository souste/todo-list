...
<img src="/todo-list/src/tick-mark.png" class="add-list-button" alt="Tick"/>
<img src="/todo-list/src/close.png" class="close-list-button" alt="Close"/>
...
<img src="/todo-list/src/tick-mark.png" class="add-project-button" alt="Tick"/>
<img src="/todo-list/src/close.png" class="close-project-button" alt="Close"/>
</div>
</form>
`;
...
class Todo {
  ...
  openTodoList(updateRenderedValues) {
    ...
    deleteListButton.innerHTML = `<img src="/todo-list/src/delete.png" alt="Delete">`;

    const closeListButton = document.createElement("div");
    closeListButton.className = "close-list-button";
    closeListButton.innerHTML = `<img src="/todo-list/src/tick-mark.png" alt="Tick">`;

    const editButton = document.createElement("div");
    editButton.className = "edit-list-button";
    editButton.innerHTML = `<img src="/todo-list/src/edit-file.png" alt="Edit">`;
